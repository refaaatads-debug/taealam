...
const ALL_PERMISSIONS: { key: string; label: string; group: string }[] = [
  { key: "view_overview", label: "النظرة العامة", group: "عرض" },
  { key: "view_advanced_analytics", label: "التحليلات المتقدمة", group: "عرض" },
  { key: "view_reports", label: "عرض التقارير", group: "عرض" },
  { key: "view_teacher_performance", label: "أداء المعلمين", group: "عرض" },
  { key: "manage_users", label: "إدارة المستخدمين", group: "المستخدمون" },
  { key: "manage_student_profiles", label: "ملفات الطلاب", group: "المستخدمون" },
  { key: "manage_teacher_profiles", label: "ملفات المعلمين", group: "المستخدمون" },
  { key: "manage_pending_teachers", label: "طلبات اعتماد المعلمين", group: "المستخدمون" },
  { key: "manage_teachers", label: "إدارة المعلمين (عام)", group: "المستخدمون" },
  { key: "manage_featured_teachers", label: "المدرسون المميزون", group: "المستخدمون" },
  { key: "manage_bookings", label: "إدارة الحجوزات", group: "الحصص" },
  { key: "manage_sessions_status", label: "حالات الجلسات المباشرة", group: "الحصص" },
  { key: "manage_session_reports", label: "تقارير الحصص", group: "الحصص" },
  { key: "manage_session_pricing", label: "تسعير الحصص", group: "الحصص" },
  { key: "manage_materials", label: "المواد التعليمية", group: "الحصص" },
  { key: "manage_plans", label: "خطط الاشتراك", group: "مالي" },
  { key: "manage_coupons", label: "الكوبونات", group: "مالي" },
  ...
  { key: "manage_wallets", label: "المحافظ والمكالمات", group: "مالي" },
  ...
  { key: "manage_domain_ssl", label: "حالة SSL/HTTPS", group: "النظام" },
