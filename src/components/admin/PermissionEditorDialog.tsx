...
const IMPACT_DESCRIPTIONS: Record<string, string> = {
  ...
  view_advanced_analytics: "يرى صفحة التحليلات المتقدمة والمخططات التفصيلية",
  ...
  manage_student_profiles: "الوصول إلى ملفات الطلاب التفصيلية",
  manage_teacher_profiles: "الوصول إلى ملفات المعلمين التفصيلية",
  manage_pending_teachers: "اعتماد ورفض طلبات المعلمين الجدد",
  manage_teachers: "صلاحية شاملة على ملفات المعلمين",
  manage_featured_teachers: "إدارة المدرسين المميزين على الصفحة الرئيسية",
  manage_bookings: "تعديل وإلغاء الحجوزات",
  manage_sessions_status: "متابعة حالات الجلسات المباشرة لحظياً",
  ...
  manage_wallets: "إدارة محافظ المستخدمين وسجل المكالمات",
  manage_violations: "مراجعة المخالفات والمكالمات",
  view_call_transcripts: "الاطلاع على تفريغ نصي للمكالمات",
  manage_ai_audit: "مراجعة جودة مخرجات الذكاء الاصطناعي",
  manage_domain_ssl: "متابعة حالة الدومين وشهادات SSL",
