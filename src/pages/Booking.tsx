  ...
  useEffect(() => {
    ...
    if (user) {
      ...
      Promise.all([
        ...
        const planDuration: number = subsData[0]?.session_duration_minutes || 60;
  ...
  return (
    <div className="min-h-screen bg-muted/30 pb-16 md:pb-0">
      ...
      <div className="container py-8 max-w-3xl">
        ...
        <>
          {step === 1 && (
            <motion.div key="step1" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
          ...
          {step === 2 && (
            <motion.div key="step2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
              <Card className="border-0 shadow-card">
                <CardHeader>
                  <CardTitle className="text-lg flex items-center gap-2 font-bold">
