...
const teachers = [
  { name: "أ. سارة المحمدي", subject: "رياضيات", rating: 4.9, students: 320, price: 80, img: teacher1 },
  { name: "أ. خالد العتيبي", subject: "فيزياء", rating: 4.8, students: 280, price: 90, img: teacher2 },
  { name: "أ. نورة الشهري", subject: "إنجليزي", rating: 4.9, students: 410, price: 70, img: teacher3 },
  { name: "أ. أحمد الحربي", subject: "كيمياء", rating: 4.7, students: 195, price: 85, img: teacher4 },
];
...
const Index = () => (
  <div className="min-h-screen flex flex-col pb-16 md:pb-0">
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container py-20 md:py-28 lg:py-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.1 } } }}>
            <motion.div variants={fadeUp} custom={0} className="inline-flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm rounded-full px-4 py-2 text-sm mb-6 border border-primary-foreground/10 text-primary-foreground">
              <Sparkles className="h-4 w-4 text-gold" />
              <span>مدعومة بالذكاء الاصطناعي</span>
            </motion.div>
            <motion.h1 variants={fadeUp} custom={1} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-[1.2] mb-4 md:mb-6 text-primary-foreground">
              مستقبل التعليم
              <br />
              <span className="opacity-90">يبدأ من هنا</span>
            </motion.h1>
            <motion.p variants={fadeUp} custom={2} className="text-base md:text-lg lg:text-xl opacity-85 mb-6 md:mb-8 max-w-lg leading-relaxed text-primary-foreground">
            ...
            <motion.div variants={fadeUp} custom={3} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button size="lg" className="gradient-cta shadow-button text-secondary-foreground text-base px-8 rounded-xl h-13 w-full sm:w-auto" asChild>
                <Link to="/search">
                  <Search className="ml-2 h-5 w-5" />
                  ابحث عن مدرسك
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10 text-base rounded-xl h-13 backdrop-blur-sm w-full sm:w-auto" asChild>
                <Link to="/login">
                  احجز حصة مجانية
            ...
            <motion.div variants={fadeUp} custom={4} className="flex items-center gap-4 sm:gap-6 mt-6 md:mt-8 pt-6 md:pt-8 border-t border-primary-foreground/10">
              <div className="flex -space-x-3 space-x-reverse">
                {[teacher1, teacher2, teacher3, teacher4].map((img, i) => (
                  <img key={i} src={img} alt="مدرس" className="w-9 h-9 rounded-full border-2 border-primary-foreground/30 object-cover" loading="lazy" width={36} height={36} />
                ))}
              </div>
              <div>
                ...
                <p className="text-xs opacity-70 text-primary-foreground">أكثر من 10,000 طالب يثقون بنا</p>
              </div>
            </motion.div>
          </motion.div>
              ...
              <div className="bg-primary-foreground/10 backdrop-blur-lg rounded-3xl p-8 border border-primary-foreground/10">
                <div className="bg-primary-foreground/10 rounded-2xl p-6 mb-4">
                  <div className="flex items-center gap-3 mb-4">
                    <img src={teacher1} alt="أ. سارة المحمدي" className="w-12 h-12 rounded-2xl object-cover" loading="lazy" width={48} height={48} />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {stats.map((s, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex items-center gap-3">
              <div className="w-10 h-10 md:w-11 md:h-11 rounded-xl bg-accent flex items-center justify-center shrink-0">
                <s.icon className="h-5 w-5 text-accent-foreground" />
              </div>
              <div>
                <p className="text-lg md:text-xl font-black text-foreground">{s.value}</p>
    ...
    <section className="py-14 md:py-20 bg-background">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-foreground mt-4 mb-3">ثلاث خطوات فقط</h2>
          <p className="text-muted-foreground text-base md:text-lg">ابدأ رحلتك التعليمية في أقل من دقيقة</p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
          {steps.map((s, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }} className="text-center relative">
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl gradient-cta flex items-center justify-center mx-auto mb-4 md:mb-5 shadow-button">
                <s.icon className="h-6 w-6 md:h-7 md:w-7 text-secondary-foreground" />
              </div>
    ...
    <section className="py-14 md:py-20 bg-muted/30">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-foreground mt-4 mb-3">لماذا تعلّم؟</h2>
          <p className="text-muted-foreground text-base md:text-lg">كل ما تحتاجه لتجربة تعليمية استثنائية</p>
        </motion.div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {services.map((s, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              <Card className="group shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1.5 border-0 h-full">
                <CardContent className="p-4 md:p-6">
                  <div className={`w-12 h-12 md:w-14 md:h-14 rounded-2xl ${s.color} flex items-center justify-center mb-3 md:mb-5 group-hover:scale-110 transition-transform duration-300`}>
                    <s.icon className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <h3 className="font-bold text-sm md:text-lg mb-1 md:mb-2 text-foreground">{s.title}</h3>
    ...
    {/* Featured Teachers with real photos */}
    <section className="py-14 md:py-20 bg-background">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex items-end justify-between mb-8 md:mb-12">
          <div>
            <span className="text-sm font-semibold text-secondary bg-accent px-4 py-1.5 rounded-full">نخبة المدرسين</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-foreground mt-4 mb-2">مدرسون مميزون</h2>
            <p className="text-muted-foreground text-sm md:text-base">نخبة من أفضل المعلمين المعتمدين والمراجعين</p>
          </div>
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              <Card className="shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1.5 border-0 overflow-hidden group">
                <div className="h-24 md:h-32 relative overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2 bg-card/80 backdrop-blur-sm rounded-full px-2 py-0.5 text-xs font-bold text-foreground">
                    <Star className="h-3 w-3 inline fill-gold text-gold ml-0.5" />{t.rating}
                  </div>
                </div>
                <CardContent className="p-3 md:p-5 text-center">
                  <h3 className="font-bold text-sm md:text-base text-foreground mb-0.5">{t.name}</h3>
                  <p className="text-xs md:text-sm text-secondary font-semibold mb-1">{t.subject}</p>
                  <p className="text-[10px] md:text-xs text-muted-foreground mb-3 md:mb-4">{t.students} طالب</p>
                  ...
                  <Button className="w-full gradient-cta shadow-button text-secondary-foreground rounded-xl text-xs md:text-sm h-9 md:h-10" asChild>
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-foreground mt-4 mb-4">مدرسك الذكي يعرفك أكثر</h2>
            ...
            <Button className="mt-6 md:mt-8 gradient-cta shadow-button text-secondary-foreground rounded-xl px-6" asChild>
              <Link to="/ai-tutor">
            ...
            <div className="relative">
              <div className="bg-card rounded-3xl shadow-card-hover p-6 border">
                ...
                <div className="space-y-3 mb-4">
                  {[{ label: "الرياضيات", val: "85%" }, { label: "الفيزياء", val: "72%" }].map((p, i) => (
                    <div key={i} className="bg-muted rounded-xl p-3">
                      <div className="flex justify-between text-xs mb-1.5">
                        <span className="text-muted-foreground">{p.label}</span>
                        <span className="font-bold text-foreground">{p.val}</span>
                      </div>
                      <div className="h-2 bg-background rounded-full overflow-hidden">
                        <div className="h-full gradient-cta rounded-full" style={{ width: p.val }} />
                      </div>
                    </div>
                  ))}
                </div>
    ...
    <section className="py-14 md:py-20 bg-background">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-foreground mt-4 mb-3">ماذا يقول مستخدمونا؟</h2>
          <p className="text-muted-foreground text-base md:text-lg">آراء حقيقية من طلاب ومعلمين وأولياء أمور</p>
        </motion.div>
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
              <Card className="shadow-card hover:shadow-card-hover transition-all duration-300 border-0 h-full">
                <CardContent className="p-5 md:p-7">
                  ...
                  <p className="text-foreground text-sm md:text-base mb-4 md:mb-5 leading-relaxed">{t.text}</p>
                  <div className="flex items-center gap-3 pt-3 md:pt-4 border-t">
                    <div className="w-10 h-10 md:w-11 md:h-11 rounded-xl gradient-hero flex items-center justify-center">
    ...
    <section className="gradient-hero text-primary-foreground py-14 md:py-20 relative overflow-hidden">
      ...
      <div className="container text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-black mb-4 md:mb-5">ابدأ رحلتك التعليمية الآن</h2>
          <p className="text-base md:text-lg opacity-85 mb-6 md:mb-8 max-w-lg mx-auto">سجّل مجاناً واحصل على أول حصة بخصم 50%</p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
            <Button size="lg" className="gradient-cta shadow-button text-secondary-foreground text-base md:text-lg px-10 rounded-xl h-12 md:h-14" asChild>
              <Link to="/login">ابدأ مجاناً</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10 text-base md:text-lg rounded-xl h-12 md:h-14 backdrop-blur-sm" asChild>
