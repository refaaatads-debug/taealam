-- Fix: SECURITY DEFINER on auto_complete_session trigger
-- Root cause: trigger ran as INVOKER (teacher JWT) and RLS blocked
-- UPDATE to user_subscriptions (student owned) silently — balances never deducted.
-- Also correct today affected subscription balances manually.
...
-- Correct subscription balances for student 00a39848 (manually missed deductions)
-- 8a7b9178 (405 min): 314 - 45(3afc,NULL) - 245(801a,NULL) = 24
-- 71f411ea (720 min): 492 - 119(542b,linked) - 9(f9b0,linked) - 6(d7aa,linked) = 358
UPDATE user_subscriptions SET remaining_minutes = 24
  WHERE id = 8a7b9178-907b-481d-b8a4-743623f77d68;
UPDATE user_subscriptions SET remaining_minutes = 358
  WHERE id = 71f411ea-7cb6-4bb3-9040-27d2ed7c3f47;
